...
try:
    while True:
        ...
        print("Welcome to Gingoog City Comprehensive National Highschool")
        display.lcd_display_string("Gingoog City Comprehensive", 1) # Write line of text to first line of display
